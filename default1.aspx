<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default1.aspx.cs" Inherits="CGS.Web.default1" %>
...
<section class="banner_section p-0 full_screen">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active background_bg overlay_bg2" data-img-src="assets/images/banner13.jpg">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-9 col-sm-12 text-center">
                        <div class="banner_content animation text_white" data-animation="fadeIn" data-animation-delay="0.8s">
                            ...
                            <%--<p class="animation my-4" data-animation="fadeInUp" data-animation-delay="1.5s">Centre System Group</p>--%>
        ...
        <div class="carousel-item background_bg overlay_bg2" data-img-src="assets/images/banner11.jpg">
        	<div class="banner_slide_content">
                <div class="container"><!-- STRART CONTAINER -->
                    <div class="row justify-content-center">
                        <div class="col-lg-9 col-sm-12 text-center">
        ...
        <div class="carousel-item background_bg overlay_bg2" data-img-src="assets/images/banner10.jpg">
        	<div class="banner_slide_content">
                <div class="container"><!-- STRART CONTAINER -->
                    <div class="row justify-content-center">
                        <div class="col-lg-9 col-sm-12 text-center">
        ...
        <div class="row align-items-center">
            <div class="col-md-6 animation" data-animation="fadeInLeft" data-animation-delay="0.2s">
            	<div class="overlay_bg about_video_img mb-4 mb-lg-0">
            		<img src="assets/images/about_img4.jpg" alt="about_img4"/>
                    
                </div>
            </div>
            <div class="col-md-6 col-sm-12 animation" data-animation="fadeInRight" data-animation-delay="0.4s">
                <div class="heading_s1"> 
                  <h2>About The Centre System Group</h2>
                </div>
                <p>Centre Systems Group helps transform the world's most important businesses into vigorous, agile organizations that anticipate the unpredictable, adapt rapidly to disruption and outcompete their opposition.</p>
               <p>We bring values to the Global leaders on their most critical issues, their Strategy, organization, operations, informationtechnology, digital transformation , advanced analytics, transformations, sustainability, across all industries and geographies. Our unique approach to traditional change management &satisfaction oriented Delivery, helps clients measure and manage risk and overcome the odds to realize results. </p>
    ...
    <div class="container">
    	<div class="row">
            <div class="col-sm-12 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                <div class="heading_s4 text-center">
                	<span class="sub_title">Solutions</span>
                    <h2>Solutions</h2>
                </div>
...
<section class="small_pb">
	<div class="container">
    	<div class="row">
        	<div class="col-md-12 animation" data-animation="fadeInUp" data-animation-delay="0.2s">
                <div class="heading_s4 text-center">
                	<span class="sub_title">Values</span>
...
<section class="counter_wrap background_bg fixed_bg overlay_bg2" data-img-src="assets/images/counter_bg2.jpg">
    <div class="container">
        ...
        <%--	<div class="col-lg-12 animation" data-animation="fadeInUp" data-animation-delay="0.4s">--%>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-6 animation" data-animation="fadeInUp" data-animation-delay="0.8s">
                        <div class="form-group">
                            ...
                            &nbsp&nbsp  &nbsp&nbsp &nbsp&nbsp<asp:TextBox ID="TextBox4" runat="server" Width="385px"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-6 animation" data-animation="fadeInUp" data-animation-delay="0.9s">
                        <div class="form-group">
                            ...
                            &nbsp&nbsp  &nbsp&nbsp &nbsp&nbsp<asp:TextBox ID="TextBox5" runat="server" Width="385px"></asp:TextBox>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-6 animation" data-animation="fadeInUp" data-animation-delay="0.10s">
                        <div class="form-group">
                            ...
                            &nbsp&nbsp  
                            <asp:DropDownList ID="DropDownList1" runat="server" class="btn btn-default dropdown-toggle" Width="400px">
                    ...
                    <div class="col-lg-6 col-md-6 col-6 animation" data-animation="fadeInUp" data-animation-delay="0.11s">
                        <div class="form-group">
                            <label for="product" style="color: white">Product<br />
                                Interested *</label>
                            <asp:DropDownList ID="DropDownList2" runat="server" class="btn btn-default dropdown-toggle">
                                <asp:ListItem>Select</asp:ListItem>
                ...
                <div class="row">
                    <div class="form-group" style="margin-left: 450px">
                        <div class="col-lg-6 col-md-6 col-6 animation" data-animation="fadeInUp" data-animation-delay="0.12s">
                            <asp:Button runat="server" ID="Button1" class=" btn btn-primary" Text="Submit" />
                        </div>
                    </div>
                </div>
            </div>
